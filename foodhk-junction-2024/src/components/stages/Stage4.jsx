...
function Stage4() {
  ...
  return (
    <section className="dark:bg-primary_login_dark">
      ...
      <Toaster position="top-center pb-10" reverseOrder={false} />
      <div className = "h-dvh">
          ...
          bg-white dark:bg-secondary_login_dark dark:border-gray-700 border-gray-300">
            ...
            <label htmlFor="beginStorage" className="block mb-2 text-sm font-medium text-[#232d42] dark:text-white">
